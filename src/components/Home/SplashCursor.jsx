...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    let observer = null;
    if (typeof IntersectionObserver !== 'undefined' && targetElement && targetElement !== window) {
    ...
    function resizeCanvas() {
      const clientW = canvas.clientWidth || canvas.parentElement?.clientWidth || window.innerWidth || 1;
      const clientH = canvas.clientHeight || canvas.parentElement?.clientHeight || window.innerHeight || 1;
    ...
    function getResolution(resolution) {
      let w = gl.drawingBufferWidth || 1;
      let h = gl.drawingBufferHeight || 1;
      let aspectRatio = w / h;
